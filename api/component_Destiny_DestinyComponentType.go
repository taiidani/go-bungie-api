...
const (
    // Destiny_DestinyComponentTypeNone represents the None enum in the Destiny.DestinyComponentType component.
    Destiny_DestinyComponentTypeNone int32 = 0

    // Destiny_DestinyComponentTypeProfiles represents the Profiles enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeProfiles int32 = 100

    // Destiny_DestinyComponentTypeVendorReceipts represents the VendorReceipts enum in the Destiny.DestinyComponentType component.
    //
    // Only applicable for GetProfile, this will return information about receipts for refundable vendor items.
    Destiny_DestinyComponentTypeVendorReceipts int32 = 101

    // Destiny_DestinyComponentTypeProfileInventories represents the ProfileInventories enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeProfileInventories int32 = 102

    // Destiny_DestinyComponentTypeProfileCurrencies represents the ProfileCurrencies enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeProfileCurrencies int32 = 103

    // Destiny_DestinyComponentTypeProfileProgression represents the ProfileProgression enum in the Destiny.DestinyComponentType component.
    //
    // This will get you any progression-related information that exists on a Profile-wide level, across all characters.
    Destiny_DestinyComponentTypeProfileProgression int32 = 104

    // Destiny_DestinyComponentTypePlatformSilver represents the PlatformSilver enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypePlatformSilver int32 = 105

    // Destiny_DestinyComponentTypeCharacters represents the Characters enum in the Destiny.DestinyComponentType component.
    //
    // This will get you summary info about each of the characters in the profile.
    Destiny_DestinyComponentTypeCharacters int32 = 200

    // Destiny_DestinyComponentTypeCharacterInventories represents the CharacterInventories enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeCharacterInventories int32 = 201

    // Destiny_DestinyComponentTypeCharacterProgressions represents the CharacterProgressions enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeCharacterProgressions int32 = 202

    // Destiny_DestinyComponentTypeCharacterRenderData represents the CharacterRenderData enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeCharacterRenderData int32 = 203

    // Destiny_DestinyComponentTypeCharacterActivities represents the CharacterActivities enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeCharacterActivities int32 = 204

    // Destiny_DestinyComponentTypeCharacterEquipment represents the CharacterEquipment enum in the Destiny.DestinyComponentType component.
    //
    // This will return info about the equipped items on the character(s). Everyone can see this.
    Destiny_DestinyComponentTypeCharacterEquipment int32 = 205

    // Destiny_DestinyComponentTypeCharacterLoadouts represents the CharacterLoadouts enum in the Destiny.DestinyComponentType component.
    //
    // This will return info about the loadouts of the character(s).
    Destiny_DestinyComponentTypeCharacterLoadouts int32 = 206

    // Destiny_DestinyComponentTypeItemInstances represents the ItemInstances enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeItemInstances int32 = 300

    // Destiny_DestinyComponentTypeItemObjectives represents the ItemObjectives enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeItemObjectives int32 = 301

    // Destiny_DestinyComponentTypeItemPerks represents the ItemPerks enum in the Destiny.DestinyComponentType component.
    //
    // Items can have perks (DestinySandboxPerkDefinition). If they do, this will return info for what perks are active on items.
    Destiny_DestinyComponentTypeItemPerks int32 = 302

    // Destiny_DestinyComponentTypeItemRenderData represents the ItemRenderData enum in the Destiny.DestinyComponentType component.
    //
    // If you just want to render the weapon, this is just enough info to do that rendering.
    Destiny_DestinyComponentTypeItemRenderData int32 = 303

    // Destiny_DestinyComponentTypeItemStats represents the ItemStats enum in the Destiny.DestinyComponentType component.
    //
    // Items can have stats, like rate of fire. Asking for this component will return requested item's stats if they have stats.
    Destiny_DestinyComponentTypeItemStats int32 = 304

    // Destiny_DestinyComponentTypeItemSockets represents the ItemSockets enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeItemSockets int32 = 305

    // Destiny_DestinyComponentTypeItemTalentGrids represents the ItemTalentGrids enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeItemTalentGrids int32 = 306

    // Destiny_DestinyComponentTypeItemCommonData represents the ItemCommonData enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeItemCommonData int32 = 307

    // Destiny_DestinyComponentTypeItemPlugStates represents the ItemPlugStates enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeItemPlugStates int32 = 308

    // Destiny_DestinyComponentTypeItemPlugObjectives represents the ItemPlugObjectives enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeItemPlugObjectives int32 = 309

    // Destiny_DestinyComponentTypeItemReusablePlugs represents the ItemReusablePlugs enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeItemReusablePlugs int32 = 310

    // Destiny_DestinyComponentTypeVendors represents the Vendors enum in the Destiny.DestinyComponentType component.
    //
    // When obtaining vendor information, this will return summary information about the Vendor or Vendors being returned.
    Destiny_DestinyComponentTypeVendors int32 = 400

    // Destiny_DestinyComponentTypeVendorCategories represents the VendorCategories enum in the Destiny.DestinyComponentType component.
    //
    // When obtaining vendor information, this will return information about the categories of items provided by the Vendor.
    Destiny_DestinyComponentTypeVendorCategories int32 = 401

    // Destiny_DestinyComponentTypeVendorSales represents the VendorSales enum in the Destiny.DestinyComponentType component.
    //
    // When obtaining vendor information, this will return the information about items being sold by the Vendor.
    Destiny_DestinyComponentTypeVendorSales int32 = 402

    // Destiny_DestinyComponentTypeKiosks represents the Kiosks enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeKiosks int32 = 500

    // Destiny_DestinyComponentTypeCurrencyLookups represents the CurrencyLookups enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeCurrencyLookups int32 = 600

    // Destiny_DestinyComponentTypePresentationNodes represents the PresentationNodes enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypePresentationNodes int32 = 700

    // Destiny_DestinyComponentTypeCollectibles represents the Collectibles enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeCollectibles int32 = 800

    // Destiny_DestinyComponentTypeRecords represents the Records enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeRecords int32 = 900

    // Destiny_DestinyComponentTypeTransitory represents the Transitory enum in the Destiny.DestinyComponentType component.
    //
    ...
    Destiny_DestinyComponentTypeTransitory int32 = 1000

    // Destiny_DestinyComponentTypeMetrics represents the Metrics enum in the Destiny.DestinyComponentType component.
    //
    // Returns summary status information about all "Metrics" (also known in the game as "Stat Trackers").
    Destiny_DestinyComponentTypeMetrics int32 = 1100

    // Destiny_DestinyComponentTypeStringVariables represents the StringVariables enum in the Destiny.DestinyComponentType component.
    //
    // Returns a mapping of localized string variable hashes to values, on a per-account or per-character basis.
    Destiny_DestinyComponentTypeStringVariables int32 = 1200

    // Destiny_DestinyComponentTypeCraftables represents the Craftables enum in the Destiny.DestinyComponentType component.
    //
    // Returns summary status information about all "Craftables" aka crafting recipe items.
    Destiny_DestinyComponentTypeCraftables int32 = 1300

    // Destiny_DestinyComponentTypeSocialCommendations represents the SocialCommendations enum in the Destiny.DestinyComponentType component.
    //
    // Returns score values for all commendations and commendation nodes.
    Destiny_DestinyComponentTypeSocialCommendations int32 = 1400
)
