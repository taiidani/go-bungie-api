...
type Destiny_Milestones_DestinyMilestone struct {
    // Activities.
    //
    ...
    Activities []Destiny_Milestones_DestinyMilestoneChallengeActivity `json:"activities"`
    ...
    AvailableQuests []Destiny_Milestones_DestinyMilestoneQuest `json:"availableQuests"`
    ...
    Rewards []Destiny_Milestones_DestinyMilestoneRewardCategory `json:"rewards"`
    ...
    Vendors []Destiny_Milestones_DestinyMilestoneVendor `json:"vendors"`
}
