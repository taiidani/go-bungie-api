...
type Tokens_CollectibleDefinitions struct {
    ...
    //
    // Defines a
    CollectibleDefinition Destiny_Definitions_Collectibles_DestinyCollectibleDefinition `json:"CollectibleDefinition"`
    ...
    DestinyInventoryItemDefinition Destiny_Definitions_DestinyInventoryItemDefinition `json:"DestinyInventoryItemDefinition"`
}
