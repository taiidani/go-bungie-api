...
type Destiny_Definitions_Loadouts_DestinyLoadoutConstantsDefinition struct {
    ...
    LoadoutColorHashes []any `json:"loadoutColorHashes"`
    ...
    LoadoutIconHashes []any `json:"loadoutIconHashes"`
    ...
    LoadoutPreviewFilterOutSocketCategoryHashes []any `json:"loadoutPreviewFilterOutSocketCategoryHashes"`
    ...
    LoadoutNameHashes []any `json:"loadoutNameHashes"`
    ...
    LoadoutPreviewFilterOutSocketTypeHashes []any `json:"loadoutPreviewFilterOutSocketTypeHashes"`
